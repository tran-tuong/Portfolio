...
const NavBar = () => {
  ...
  return (
    <header className="w-full flex items-center justify-between px-32 py-8 font-medium z-10 relative lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="absolute left-[48%] top-3 translate-x-[48%] lg:left-[45%] lg:translate-x-[45%] md:translate-x-[43%] md:left-[43%] sm:translate-x-[41%] sm:left-[41%] xs:translate-x-[38%] xs:left-[38%]">
        <Logo />
      </div>
